        ...
        <div className="flex flex-wrap gap-12 justify-between max-w-6xl w-full">
          ...
          <div className="flex-1 text-white min-w-[300px]">
            ...
            <div className="flex flex-wrap gap-4">
              {/* Primary Button → Open AuthModal */}
              <button
                onClick={() => setAuthOpen(true)}
                className="bg-gradient-to-r from-indigo-500 to-pink-500 text-white px-6 py-3 rounded-full font-semibold transition-transform duration-300 hover:scale-105 hover:bg-transparent hover:border-2 hover:border-pink-500"
              >
